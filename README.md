...
```javascript
dnanvariance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanvariance@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dnanvariance/tags). For example,

```javascript
dnanvariance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanvariance@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanvariance = require( 'path/to/vendor/umd/stats-strided-dnanvariance/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanvariance@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dnanvariance.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dnanvariance

[test-image]: https://github.com/stdlib-js/stats-strided-dnanvariance/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-dnanvariance/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dnanvariance/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dnanvariance?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dnanvariance.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dnanvariance/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dnanvariance/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dnanvariance/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dnanvariance/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dnanvariance/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dnanvariance/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dnanvariance/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dnanvariance/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dnanvariance/main/LICENSE
